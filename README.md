...
This project is a CHIP-8 emulator written in pure C as a learning project. It implements the complete CHIP-8 instruction set, graphical output using SDL2, keyboard input, sound generation and a custom unit testing framework.
